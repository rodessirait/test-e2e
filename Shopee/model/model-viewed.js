...
export default class View {
    constructor (){
        ...
        this.listGist = Selector('#gist-pjax-container > div.gisthead.pagehead.repohead.instapaper_ignore.readability-menu.experiment-repo-nav.mb-4 > div > div > ul > li.flex-auto.py-3.text-bold.text-right.f6.lh-condensed > a');
    }
}